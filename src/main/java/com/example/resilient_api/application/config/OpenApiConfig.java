...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Capacity & Bootcamp Management API")
                        .version("1.0.0")
                        .description("""
                                API para la gestión de capacidades y bootcamps.
                                
                                **Funcionalidades principales:**
                                - Gestión de capacidades (CRUD)
                                - Gestión de bootcamps (CRUD)
                                - Inscripción de usuarios en bootcamps
                                - Consulta de bootcamps por usuario
